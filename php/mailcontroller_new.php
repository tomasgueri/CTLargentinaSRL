...
$mail->AddReplyTo($_REQUEST['email'],"Idrotermica DF User");
$mail->SetFrom($_REQUEST['email'], 'Idrotermica DF User');


$address = "info@idrotermicadf.it";
$mail->AddAddress($address, "Idrotermica DF User");
